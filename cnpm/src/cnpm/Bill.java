...
public void createInvoice()
{
           ...
           String idInVoice=di.getIDInvoice(getIdCar(),String.valueOf(sdf1.format(cal1.getTime())));
           Document a=new Document();
            ...
            Font timeNormal12 = new Font(nationalBase, 12f, Font.NORMAL);
              ...
              Paragraph textInvoiceNo= new Paragraph();
               ...
               textInvoiceNo.add("\nInvoice No.: ") ;
                idInVoice=di.getIDInvoice(getIdCar(),String.valueOf(sdf1.format(cal1.getTime())));
...
//                textCompany.setAlignment(Paragraph.ALIGN_LEFT);
               ...
               textTableContent.setAlignment(Paragraph.ALIGN_CENTER);
                  ...
                  // TABLE
                  int total=0;
                getInforDetailWithIDCAR(getIdCar());
         ...
         // TOTAL
               ...
               di.updateTotalInvoice(idInVoice, String.valueOf(total));
...
;
         ...
         // COMMENT       
            ...
            SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy HH:mm:ss");
               ...
               textComment.add("\n"+sp.getStaffNameFromID(getIdStaff())) ;
               textComment.add("\nInvoice Date: ");
...
//        
//    }
   public void getInforDetailWithIDCAR(String CarID)
    {
        DefaultTableModel dtm=(DefaultTableModel)tbDetail.getModel();
        updateGuestCar gc=new updateGuestCar();
        updateService se=new updateService();
        ...
        Connection c=Connecting.Connect();
        String sql="Select MALK,SOLUONGLK from ChiTietLinhKien where MAXE='"+CarID+"'";
        String sqlService="Select MADV from ChiTietDichVu where MAXE='"+CarID+"'";
        try {
            PreparedStatement pr=c.prepareStatement(sql);
            ResultSet rs=pr.executeQuery();
            String idAccess;
            while(rs.next())
            {
                v=new Vector();
                v.add(ap.getAccessName(rs.getString(1)));
                idAccess=rs.getString(1);
                v.add(gc.getNameCarFromId(CarID));
                int quantity=Integer.parseInt(rs.getString(2));
                v.add(rs.getString(2));
                            String sql1="Select DONGIA from LinhKien where MALK='"+idAccess+"'";
                            PreparedStatement pr1=c.prepareStatement(sql1);
                            ResultSet rs1=pr1.executeQuery();
                            while(rs1.next())
                            {
